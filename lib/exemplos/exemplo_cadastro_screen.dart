...
class ExemploCadastroScreen extends StatefulWidget {
  const ExemploCadastroScreen({super.key});

  @override
  State<ExemploCadastroScreen> createState() => _ExemploCadastroScreenState();
}

class _ExemploCadastroScreenState extends State<ExemploCadastroScreen> {
